...
public class MethodOverload : MonoBehaviour
{
    ...
    {
        //1234출력
        PrintNumber(1234); //int
        PrintNumber(1234f); //float
        PrintNumber(1234L); //Long
    }
    ...
    //float형 실수를 매개변수로 입력받아 출력하는 함수
    void PrintNumber(float number)
    {
        Debug.Log($"실수형: {number}");
    }
    //long형 실수를 매개변수로 입력받아 출력하는 함수
...
/* 
  ...
  : 동일한 이름의 메서드를 매개변수를 달리해서 여러개 생성(정의)한 것
